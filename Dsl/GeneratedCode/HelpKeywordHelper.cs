...
namespace Sawczyn.Sequencer
{
	...
	/// </remarks>
	public partial class SequencerHelpKeywordHelper : SequencerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new SequencerHelpKeywordHelper.
		/// </summary>
		protected SequencerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the SequencerHelpKeywordHelper.
		/// </summary>
		public static SequencerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class SequencerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new SequencerHelpKeywordHelperBase.
		/// </summary>
		protected SequencerHelpKeywordHelperBase()
			: base() { }
