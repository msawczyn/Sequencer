...
namespace Sawczyn.Sequencer
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides Sequencer files
	/// The implementation is done in SequencerDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class SequencerDirectiveProcessor : SequencerDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public SequencerDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides Sequencer files
	/// </summary>
	public class SequencerDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string SequencerDirectiveProcessorName = "SequencerDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "SequenceDiagram";
		...
		/// </summary>
		private const string supportedDirectiveName = "Sequencer";
		...
		/// Constructor
		/// </summary>
		public SequencerDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return SequencerDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Sawczyn.Sequencer.SequenceDiagram));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Sawczyn.Sequencer.SequenceDiagram));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "SequenceDiagram" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"Sawczyn.Sequencer.SequencerDomainModel",
					};
