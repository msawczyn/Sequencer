...
namespace Sawczyn.Sequencer
{
	...
	/// </summary>
	internal partial class SequencerCommandSet : SequencerCommandSetBase
	{
		/// <summary>
		/// Constructs a new SequencerCommandSet.
		/// </summary>
		public SequencerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class SequencerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new SequencerCommandSetBase.
		/// </summary>
		protected SequencerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewSequencerExplorerCommand,
				typeof(SequencerEditorFactory).GUID);
		...
		{
			SequencerExplorerToolWindow explorer = this.SequencerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected SequencerDocData CurrentSequencerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as SequencerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected SequencerDocView CurrentSequencerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as SequencerDocView;
			}
		}
		...
		/// </summary>
		protected SequencerExplorerToolWindow SequencerExplorerToolWindow
		{
			get
			{
				SequencerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(SequencerExplorerToolWindow), true) as SequencerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				SequencerExplorerToolWindow explorerWindow = this.SequencerExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class SequencerClipboardCommandSet : SequencerClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new SequencerClipboardCommandSet.
		/// </summary>
		public SequencerClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class SequencerClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new SequencerClipboardCommandSetBase.
		/// </summary>
		protected SequencerClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
