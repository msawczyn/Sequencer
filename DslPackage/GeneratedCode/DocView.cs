...
namespace Sawczyn.Sequencer
{
	...
	/// </summary>
	internal partial class SequencerDocView : SequencerDocViewBase
	{
		/// <summary>
		/// Constructs a new SequencerDocView.
		/// </summary>
		public SequencerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class SequencerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new SequencerDocView.
		/// </summary>
		protected SequencerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			SequencerDocDataBase docData = this.DocData as SequencerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for SequencerDocViewBase should be an SequencerDocDataBase!");
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Sawczyn.Sequencer.SequencerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Sawczyn.Sequencer.SequencerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.SequencerDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Sawczyn.Sequencer.SequencerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Sawczyn.Sequencer.SequencerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Sawczyn.Sequencer.SequencerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
